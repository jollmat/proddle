export const i18n_ES = {
  ...
  carousel: {
    step1: {
      title: 'Administra',
      text: 'Confecciona tu listado de productos y añade o actualiza en el momento que desees el precio que tenga en la tienda deseada.',
    },
    step2: {
      title: 'Interactúa',
      text: 'Introduce productos y precios de forma fácil y cómoda mediante la cámara de tu teléfono móvil y el ticket de compra.',
    },
    step3: {
      title: 'Analiza',
      text: 'Visualiza y analiza los datos de tiendas con precios más caros, más baratos y otros.',
    },
    step4: {
  ...
  shop: {
    ...
    noRecommendedProducts: 'No hay productos de compra recomendados'
  },
  products: {
  ...
  alerts: {
    unreadInfoText: 'Tienes alertas sin leer. Puedes marcarlas como leídas haciendo clic en la que desees.'
  },
  purchases: {
    purchases: 'Compras',
    searchPlaceholder: 'Busca por nombre, marca o tienda',
    noData: 'No hay compras'
  },
  commons: {
    back: 'Volver',
    prices: 'precios',
