export const i18n_CA = {
  login: {
    welcome: 'Benvingut/da',
    'welcome.subtitle':
      "Necessitem un mínim de dades per a poder moderar l'aplicació.",
    ...
    passwordLengthError: 'Les contrasenyes han de tenir un mínim de 6 caràcters.'
  },
  carousel: {
    step1: {
      title: 'Administra',
    ...
    step2: {
      title: 'Interactua',
      text: 'Introdueix productes i preus de manera fàcil i còmoda mitjançant la càmera del teu telèfon mòbil i el ticket de compra.',
    },
    step3: {
      title: 'Analitza',
      text: "Visualitza i analitza les dades de botigues amb preus més cars, més barats i d'altres.",
    },
    step4: {
  ...
  scanner: {
    ...
    brand: 'Marca',
    price: 'Preu',
    productRegistered: 'Producte ja enregistrat',
    productNotRegistered: 'Producte no enregistrat',
    productUnknown: 'Producte desconegut',
